...
class VerificationResultViewController: UIViewController, UISearchBarDelegate {
...
extension VerificationResultViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, editActionsForRowAt indexPath: IndexPath) -> [UITableViewRowAction]? {
        ...
        let report = UITableViewRowAction(style: .destructive, title: "Report", handler: {action, indexPath in })
